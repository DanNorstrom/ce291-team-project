...
public class SMATD extends JFrame {
    ...
    public SMATD(){
        ...
        DnDPanel panel_1 = new DnDPanel(this);
        ...
        ImageIcon imageIcon = new ImageIcon(ClassLoader.getSystemResource("Images/button_choose-file.png")); //Icon made by https://www.flaticon.com/authors/gregor-cresnar from www.flaticon.com
        Image scaledImage = imageIcon.getImage().getScaledInstance(100, 30,  java.awt.Image.SCALE_SMOOTH); // scale it the smooth way  
        ...
        comboBox.setBounds(12, 108, 245, 41);
        ...
        JCheckBox chckbxSendAsEmail = new JCheckBox("Send as email:");
        chckbxSendAsEmail.setBounds(10, 150, 128, 23);
        panel1.add(chckbxSendAsEmail);
        
        textField = new JTextField();
        textField.setBounds(128, 149, 130, 26);
        panel1.add(textField);
        
        JLabel lblOutputType = new JLabel("Output type");
        lblOutputType.setBounds(18, 87, 75, 16);
        ...
        btnGrw.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(fileChosenDir != null){smat = new SMAT(fileChosenDir, outputType, chckbxSendAsEmail.isSelected(), textField.getText());}
                else{JOptionPane.showMessageDialog(null, "No file uploaded.");}
            }
        });
        
        btnGrw.setFont(new Font("Lucida Grande", Font.PLAIN, 11));
        btnGrw.setBounds(12, 185, 117, 41);
        panel1.add(btnGrw);
        ...
        btnQuit.setBounds(139, 185, 117, 41);
        panel1.add(btnQuit);
        ...
        module_perf.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(fileChosenDir != null){
                    smat = new SMAT(fileChosenDir, "NULL", chckbxSendAsEmail.isSelected(), textField.getText());
